    ...
    <Layout>
      <div className="text-bg-dark d-flex h-100">
        <Container as="main" className="py-5 text-center">
          <h2 className="text-decoration-underline mb-5">ABOUT</h2>
          <Row className="row-cols-1 row-cols-lg-2">
            <Col className="d-flex flex-column justify-content-around">
              ...
              <p>
                In a time of increasing computerisation, it’s our mission to
                keep human connection at the heart of commerce.
              </p>
              <p>
              ...
              <p>
                We help our community of sellers turn their ideas into
