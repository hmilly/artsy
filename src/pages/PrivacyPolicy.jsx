...
const PrivacyPolicy = () => {
  return (
    <Layout>
      <div className="text-bg-dark d-flex h-100">
        <Container as="main" className="my-3 p-3 p-sm-5 text-center">
          <h2 className="text-decoration-underline mb-5">
            PRIVACY INFORMATION NOTICE
          </h2>
          <Row className="row-cols-1 gap-4">
            <Col as="p">
              Artsy (“we”, “us”, “our”) are committed to protecting and
            ...
            <Col className="text-start ">
              ...
              <ul className="ms-3 ms-sm-5">
                <li>
                  To provide you with the listing information you have
                  interacted with
                </li>
                <li>
            ...
            <Col className="text-start ">
              ...
              <ul className="ms-3 ms-sm-5">
                ...
                <li>
                  In order to provide you with our and third party services
                </li>
              </ul>
            </Col>
            ...
            <Col>
              <p>
                ...
                necessary to provide you with our services or as required by
                law.
              </p>
            </Col>
            <Col as="p">
              ...
              on our website. Thank you. Artsy
            </Col>
          </Row>
        </Container>
      </div>
